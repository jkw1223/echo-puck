...
class MicroWakeWord(
    ...
    init {
        ...
        Log.d("MicroWakeWord", "MicroWakeWord engine created with handle: $nativeHandle")
    }
    ...
    fun reset() {
        ...
        Log.d("MicroWakeWord", "MicroWakeWord reset")
    }
    ...
    override fun close() {
        if (nativeHandle != 0L) {
            Log.d("MicroWakeWord", "Closing MicroWakeWord engine with handle: $nativeHandle")
    ...
    private companion object {
        ...
        private val libraryLoaded: Unit by lazy {
            ...
            Log.d("MicroWakeWord", "Loaded microwakeword native library")
            Unit
        }
